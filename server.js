...
app.get('/admin/users', checkAdmin, async (req, res) => {
  try {
    ...
    res.render('admin/adminallUsers', { users });
  } catch (error) {
...
app.post("/admin/add-style", async (req, res) => {
...
app.get('/admin/dashboard', checkAdmin, async (req, res) => {
  ...
  res.render('admin/adminDashboard', { appointments, selectedDate: today });
});



app.post('/admin/filter', checkAdmin, async (req, res) => {
  const { date } = req.body;
  ...
  res.render('admin/adminDashboard', { appointments, selectedDate: date });
});
